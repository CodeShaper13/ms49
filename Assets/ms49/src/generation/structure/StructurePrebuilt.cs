...
[CreateAssetMenu(fileName = "Structure", menuName = "MS49/Structure/Prebuilt", order = 1)]
public class StructurePrebuilt : StructureBase {
...
#if UNITY_EDITOR
    [CustomEditor(typeof(StructurePrebuilt))]
    public class StructureEditor : Editor {
        ...
        private void SetValue(SerializedProperty cell, int i, int j) {
            string[,] previousCells = (target as StructurePrebuilt).GetCells();
